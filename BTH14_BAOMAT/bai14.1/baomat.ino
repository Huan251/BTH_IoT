...
const char* ssid = "Só Chim Tăn";         // <--- CHANGE ME
const char* password = "10101010";        // <--- CHANGE ME

// IP của máy tính chạy Home Assistant
const char* mqtt_server = "10.153.38.252";      // <--- CHANGE ME (IP của HA)
const int mqtt_port = 1883;

// Tài khoản đã tạo ở Bước 2.2
const char* mqtt_user = "huanle";           // <--- CHANGE ME
const char* mqtt_pass = "1234";              // <--- CHANGE ME

const char* student_id = "10123150";           // <--- CHANGE ME (Mã SV)
const char* mqtt_topic = "iot/lab1/10123150/sensor"; // <--- CHANGE ME (Phải khớp với student_id)
/* ================================================ */
